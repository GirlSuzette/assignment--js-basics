...
function calcSpeedTicket( speedlimit, speedFracc, zona){

    if (speedlimit >= speedFracc){
        return 0
    }else if (speedFracc - speedlimit < 20 && zona === false){
        return 150

    }else if ( speedFracc >= speedlimit - 20 && zona == false){
        return 250

    }else if ( speedFracc - speedlimit < 20 && zona == true){
        return 300
